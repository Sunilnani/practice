...
import 'package:flutter_proj/networkcalls/base_network.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void fetch_users() async {
    ...
    try {
      ...
      Response response = await dioClient.ref.get("/search/users?q=followers%3A%3E%3D1000&ref=searchresults&s=followers&type=Users",
